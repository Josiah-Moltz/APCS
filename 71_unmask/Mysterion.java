...
*/
  ...
  public static void main(String[] args) {
    ...
    int[] arr10 = {2, 42, 3, 5, 91, 34, 88, 22, 153};
    partitionator(arr10, 0, 8, 2);
    print(arr10);

    int[] arr11 = {2, 42, 3, 5, 91, 34, 88, 22, 153};
    partitionator(arr11, 0, 8, 5);
    print(arr11);

    int[] arr12 = {2, 42, 3, 5, 91, 34, 88, 22, 153};
    partitionator(arr12, 0, 8, 8);
    print(arr12);
  }
